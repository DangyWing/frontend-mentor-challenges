...
export const MobileForm = ({
  ...
  return (
    <div className=" flex w-72 flex-col justify-center rounded-3xl rounded-br-[120px] bg-white p-4">
      <Form {...form}>
        <form
          onChange={() => {
            form.clearErrors();
        ...
        >
          ...
          <div className="relative my-8 flex items-center justify-center">
            ...
            <button className="bg absolute inline-flex h-12 w-12 items-center justify-center rounded-full bg-ageCalculator-purple">
              <Image
      ...
      <div className="flex flex-col">
        <div className="flex text-4xl font-extrabold italic">
